...
| Kernel Hub / Transformers | [RT-DETR CPU and L4 validation](kernel-hub/README.md) | Latest full L4 run: Phase 1 passed, RT-DETR 19/20; BF16 AMP compiled training gradient mismatch remains; corrected CPU fixture 20/20 |
