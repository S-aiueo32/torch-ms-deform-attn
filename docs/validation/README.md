...
| Kernel Hub / Transformers | [RT-DETR CPU and L4 validation](kernel-hub/README.md) | CUDA artifact built; initial 14/20 plus passing focused rechecks of six compiled failures under documented policies; final full matrix and strict FP16 operator parity remain open; CPU fixture 20/20 |
