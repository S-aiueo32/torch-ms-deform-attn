...
| --- | --- | --- | --- |
| [Indexing and native autograd](direct-20260917-fix/README.md) | FP32 decoder forward + backward, wall | 207.66 → 164.38 µs | 20.8% lower latency with metadata checks retained |
| Same experiment | FP32 encoder forward, wall | 670.46 → 633.12 µs | 5.6% lower latency; HF measured 600.46 µs |
| [Metadata switch](direct-20260917-toggle/README.md) | FP32 encoder forward, CUDA Graph | 648.24 → 623.96 µs | Unchecked is 3.75% faster than checked |

The same-toolchain [HF rebuild](direct-20260917-rebuild/README.md) found little
...
The [metadata-switch report](direct-20260917-toggle/README.md) identifies the
...
| --- | --- |
| [Initial direct profiling](direct-20260917/README.md) | Which indexing, validation, and Python-call costs explain the gap? |
| [Production indexing/autograd changes](direct-20260917-fix/README.md) | Do the guarded implementation and native autograd improve performance and preserve correctness? |
| [Matched HF rebuild](direct-20260917-rebuild/README.md) | Does the toolchain explain the remaining gap, and what does removing launch bounds change? |
| [Runtime metadata switch](direct-20260917-toggle/README.md) | Does the public switch preserve integration behavior and remove checking cost? |

Earlier GHA comparisons remain available as historical evidence:
[initial trial](run-35208208001/benchmark-tables.md),
[native dispatcher trial](run-35210946607/benchmark-tables.md), and
[same-process comparison](run-35212849809/benchmark-tables.md).
